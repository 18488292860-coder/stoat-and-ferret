...
This is the first step in C4 architecture documentation generation for `stoat-and-ferret` version `v005`.
- **Mode:** `full` (full = all directories; delta = only changed since previous version)
- **Previous C4 commit:** N/A (full mode)
...
Save outputs to `comms/outbox/exploration/c4-v005-001-discovery/`:
