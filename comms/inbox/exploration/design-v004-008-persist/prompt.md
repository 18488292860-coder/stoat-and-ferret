...
Call the MCP design tools to persist all drafted documents to the inbox folder structure for stoat-and-ferret version v004.

## Context

This is Phase 3 (Document Drafts & Persistence) for stoat-and-ferret version v004.

Task 007 created all document drafts in comms/outbox/exploration/design-v004-007-drafts/drafts/. Now persist them using MCP tools.
...
```
drafts_dir = comms/outbox/exploration/design-v004-007-drafts/drafts/
```
...
Create in comms/outbox/exploration/design-v004-008-persist/:
...
```bash
git add comms/outbox/exploration/design-v004-008-persist/
git commit -m "exploration: design-v004-008-persist - documents persisted to inbox"
```