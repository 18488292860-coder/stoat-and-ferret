Audit v003 and v004 of stoat-and-ferret for "wiring gaps" — things that were designed and implemented as individual pieces but never connected, settings defined but never consumed, functions created but never called, or features marked complete that aren't functional at runtime.
...
Create findings in comms/outbox/exploration/wiring-audit-v003-v004/:
...
## When Complete
git add comms/outbox/exploration/wiring-audit-v003-v004/
git commit -m "exploration: wiring-audit-v003-v004 complete"
