...
```bash
git checkout -b v002/01-rust-python-bindings/003-range-list-ops
```
...
**Feature:** 003-range-list-ops

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/01-rust-python-bindings/003-range-list-ops/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/01-rust-python-bindings/003-range-list-ops/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/01-rust-python-bindings/003-range-list-ops/`:
