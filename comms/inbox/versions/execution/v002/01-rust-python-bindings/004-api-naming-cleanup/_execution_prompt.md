...
```bash
git checkout -b v002/01-rust-python-bindings/004-api-naming-cleanup
```
...
**Feature:** 004-api-naming-cleanup

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/01-rust-python-bindings/004-api-naming-cleanup/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/01-rust-python-bindings/004-api-naming-cleanup/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/01-rust-python-bindings/004-api-naming-cleanup/`:
