...
```bash
git checkout -b v002/02-tooling-process/001-agents-pyo3-guidance
```
...
**Feature:** 001-agents-pyo3-guidance

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/02-tooling-process/001-agents-pyo3-guidance/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/02-tooling-process/001-agents-pyo3-guidance/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/02-tooling-process/001-agents-pyo3-guidance/`:
