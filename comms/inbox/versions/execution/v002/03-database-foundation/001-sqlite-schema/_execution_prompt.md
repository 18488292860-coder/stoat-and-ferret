...
```bash
git checkout -b v002/03-database-foundation/001-sqlite-schema
```
...
**Feature:** 001-sqlite-schema

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/03-database-foundation/001-sqlite-schema/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/03-database-foundation/001-sqlite-schema/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/03-database-foundation/001-sqlite-schema/`:
