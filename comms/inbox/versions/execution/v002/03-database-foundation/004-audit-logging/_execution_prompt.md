...
```bash
git checkout -b v002/03-database-foundation/004-audit-logging
```
...
1. **Requirements:** `comms/inbox/versions/execution/v002/03-database-foundation/004-audit-logging/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/03-database-foundation/004-audit-logging/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/03-database-foundation/004-audit-logging/`:
