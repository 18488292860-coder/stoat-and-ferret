...
```bash
git checkout -b v002/04-ffmpeg-integration/002-executor-protocol
```
...
**Feature:** 002-executor-protocol

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/04-ffmpeg-integration/002-executor-protocol/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/04-ffmpeg-integration/002-executor-protocol/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/04-ffmpeg-integration/002-executor-protocol/`:
