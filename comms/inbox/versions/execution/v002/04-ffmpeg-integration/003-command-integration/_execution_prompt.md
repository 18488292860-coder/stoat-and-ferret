...
```bash
git checkout -b v002/04-ffmpeg-integration/003-command-integration
```
...
**Feature:** 003-command-integration

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/04-ffmpeg-integration/003-command-integration/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/04-ffmpeg-integration/003-command-integration/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/04-ffmpeg-integration/003-command-integration/`:
