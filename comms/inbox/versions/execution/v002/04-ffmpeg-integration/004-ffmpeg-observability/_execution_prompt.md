...
```bash
git checkout -b v002/04-ffmpeg-integration/004-ffmpeg-observability
```
...
**Feature:** 004-ffmpeg-observability

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/04-ffmpeg-integration/004-ffmpeg-observability/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/04-ffmpeg-integration/004-ffmpeg-observability/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/04-ffmpeg-integration/004-ffmpeg-observability/`:
