...
```bash
git checkout -b v003/01-process-improvements/002-migration-ci-verification
```
...
**Feature:** 002-migration-ci-verification

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/01-process-improvements/002-migration-ci-verification/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/01-process-improvements/002-migration-ci-verification/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/01-process-improvements/002-migration-ci-verification/`:
