...
```bash
git checkout -b v003/01-process-improvements/003-ci-path-filters
```
...
**Feature:** 003-ci-path-filters

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/01-process-improvements/003-ci-path-filters/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/01-process-improvements/003-ci-path-filters/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/01-process-improvements/003-ci-path-filters/`:
