...
```bash
git checkout -b v003/02-api-foundation/002-externalized-settings
```
...
**Feature:** 002-externalized-settings

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/02-api-foundation/002-externalized-settings/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/02-api-foundation/002-externalized-settings/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/02-api-foundation/002-externalized-settings/`:
