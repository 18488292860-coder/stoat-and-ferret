...
```bash
git checkout -b v003/02-api-foundation/003-health-endpoints
```
...
**Feature:** 003-health-endpoints

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/02-api-foundation/003-health-endpoints/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/02-api-foundation/003-health-endpoints/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/02-api-foundation/003-health-endpoints/`:
